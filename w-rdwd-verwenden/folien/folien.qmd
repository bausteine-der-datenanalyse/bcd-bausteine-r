...
- Wir stellen fest, dass zwar alle Berliner Stationen ausgewählt wurden, aber auch zwei Stationen in Süddeutschland, deren Namen die Buchstabenfolge "berlin" enthalten (die letzten beiden)
- Um diesem Fehler vorzubeugen ergänzen wir einen Filter, der sicherstellt, dass der Name der Station mit "Berlin-" beginnt (filter(grpl()))
