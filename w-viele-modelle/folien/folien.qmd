...
- Ausführliche Erklärung in R for Data Science (<https://r4ds.hadley.nz>), Kapitel 25
- Linearer Trend: Einfachster Fall eines Modells von Daten

## Für eine Station einfach 1/2 {.smaller}
...
## Modelle erstellen mit `map` {.smaller}
