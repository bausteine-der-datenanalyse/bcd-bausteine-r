...
- Funktionen im `sf`-Paket beginnen mit `st_` (man muss nicht alles verstehen)
...
d_bl <- gisco_get_nuts(country = "Germany", nuts_level = 2, resolution = 10)
...
- Aufbereiten der Daten nicht ganz trivial (zusammenfügen, auswählen und vereinfachen)
