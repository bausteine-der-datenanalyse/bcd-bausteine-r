...
Laden Sie [02-einzelne-merkmale.zip](02-einzelne-merkmale.zip) herunter und entpacken Sie die Zip-Datei. Doppelklicken Sie die Projektdatei `einzelne-merkmale-aufgaben.Rproj` und öffnen Sie dann in RStudio das Dokument `einzelne-merkmale-aufgaben.qmd`. Führen Sie die Datei aus und zeigen Sie in einer eigenen Folie den Dataframe `d_bo_vm` an. Erzeugen Sie mit `Render` die html-Folien und überprüfen Sie das Ergebnis.
...
1.  Wie viele der befragten Personen sind weiblich, wie viele männlich?
