---
title: "Erste Schritte in RStudio"
---
...
# Speichern
ggsave("../folien/bilder/beispiel1-p1.png", plot = p1)
ggsave("../folien/bilder/beispiel1-p2.png", plot = p2)
```
::::: columns
::: {.column width="47%"}
![](bilder/beispiel1-p1.png)
:::
...
1. Umgebung (u.A.): Aktuell definierte Variablen
1. Konsole (u.A.): Hier können Sie direkt R-Befehle eingeben
1. Hilfe (u.A.): Hilfe zu Funktionen (nicht immer einfach zu verstehen)
