---
title: "Statistik mit R und Quarto in RStudio"
...
# Aufräumen
rm(p1, p2, d_bl, d_de, d_stat_a, d_ns_jahr)
```
...
Tageswerte der Niederschläge liegen beim Deutschen Wetterdienst in Form von CSV-Dateien vor. Wie entstehen die Folien, die Sie sehen?
...
2.  [Quarto](https://quarto.org) erstellt daraus das HTML-Dokument
...
-   Programmiersprache für statistische Berechnungen und Visualisierung von Daten
...
## Die Oberfläche von RStudio {.smaller}
...
-   Ergebnisse und Grafiken von Hand in Textdokument / Präsentation übernehmen
...
-   Daraus wird PDF/HTML/Word/PPT erzeugt (ähnlich wie LaTeX aber mit Berechnungen)
...
## Quarto-Markdown-Dokumente {.smaller}
...
-   besteht danach aus
    -   Blöcken mit R-Code, den sogenannten 'Chunks'
    -   Text in spezieller Markdown-Schreibweise (wie Wikipedia)
