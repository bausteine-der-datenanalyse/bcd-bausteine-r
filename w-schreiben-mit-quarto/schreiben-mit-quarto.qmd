...
Tabellen lassen sich aus einem Dataframe mit der Funktion `gt` erzeugen, ein Minimalbeispiel zeigt @tbl-mathematische-konstanten. Auch hier kann wieder mithilfe der Bezeichnung des R-Chunks aus dem Text auf die Tabelle verwiesen werden.
...
gt(d, caption = "Mathematische Konstanten") |>
