...
1. In der einen Rmd-Datei werden die Daten geladen und aufbereitet. Die fertigen Daten können
dann auf der Festplatte abgelegt werden

1. In einer anderen Rmd-Datei werden die aufbereiteten Daten von der Festplatte eingelesen und
...
save(d, file = "data/test.RData")
rm(list = "d")
```

Dataframe `d` 
1. anlegen
1. in der Datei `data/test.RData` speichern
